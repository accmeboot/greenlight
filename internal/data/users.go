...
func (m UserModel) Insert(user *User) error {
	...
	row := m.DB.QueryRowContext(ctx, query, user.Name, user.Email, user.Password.hash, user.Activated)
...
func ValidateEmail(v *validator.Validator, email string) {
	...
	//_, err := mail.ParseAddress(strings.TrimPrefix(email, ""))
	//v.Check(err != nil, "email", "must be a valid email undress")
